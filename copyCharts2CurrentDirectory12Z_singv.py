...
for i in range(0,52,1):
	...
	modelRunDateObj += timedelta(hours=1)
	print(temp)
				...
				for fileType in list_fileType:
					...
					for dateString in list_dateString:
						...
						if (os.path.isfile(fileName)):
							shutil.copyfile(fileName,charts_dir + "current/" + "singv" + domainName + list_LvlOut[list_Lvl.index(lvlName)] + list_VarOut[list_Var.index(varName)] + hourString + fileType)
						i += 1
